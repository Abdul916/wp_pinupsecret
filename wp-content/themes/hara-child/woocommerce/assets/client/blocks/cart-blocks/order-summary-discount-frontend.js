	...
	[5269], {
		...
		9366: (e, t, o) => {
			...
			const T = ({
					...
					const E = (0, y.useInstanceId)(T),
						k = (0, R.s)(t),
						C = (0, R.s)(o),
						N = (0, R.s)((0, m.objectHasProp)(u, "country") ? u.country : ""),
						A = (0, c.useMemo)((() => {
							const e = (0, I.Z)(k, C, N);
							return {
								fields: e,
		...
		8810: (e, t, o) => {
			...
			const f = ({
				...
				})) > 1 || document.querySelectorAll(".wc-block-components-shipping-rates-control__package").length > 1, f = null != d ? d : C, y = null != m ? m : C, R = (0, n.createElement)(n.Fragment, null, (y || f) && (0, n.createElement)("div", {
			...
			const _ = ({
				...
				E = ({
					...
					return (0, n.createElement)(c.Z, {
						...
						showSpinner: !0
					}, S && "woocommerce/cart" === C && e.length > 1 && !T && !N && (0, n.createElement)(m.Z, {
		...
		7184: (e, t, o) => {
			...
			const C = ({
				...
				const c = (0, _.getSetting)("taxesEnabled", !0) && (0, _.getSetting)("displayCartPricesIncludingTax", !1),
					...
					g = (0, h.applyCheckoutFilter)({
						...
						defaultValue: (0, s.__)("Total Edit By Xl 3", "woocommerce"),
			...
			const K = () => {
				...
				Z = ({
					...
					const {
						isEditor: c
					} = (0, P._)(), r = (0, p.useSelect)((e => e(u.CHECKOUT_STORE_KEY).prefersCollection())), l = (0, _.getSetting)("activeShippingZones"), i = l.length > 1 && l.some((e => "Everywhere" === e.description || "Locations outside all other zones" === e.description)), m = !!(0, R.ET)(a);
					if (!m && !c && !i) return null;
					const d = m ? (0, s.__)("Change address", "woocommerce") : (0, s.__)("Calculate shipping for your location", "woocommerce"),
						g = (0, R.ET)(a);
					return (0, n.createElement)(n.Fragment, null, r ? (0, n.createElement)(K, null) : (0, n.createElement)(F, {
						formattedLocation: g
					}), e && (0, n.createElement)(D, {
						label: d,
						isShippingCalculatorOpen: t,
			...
			const U = ({
				...
				const [m, g] = (0, a.useState)(!1), {
					...
					shippingRates: E,
					isLoadingRates: b
				} = (0, v.b)(), k = (0, L.KR)(t), C = (0, L.CN)(E) || k > 0, w = o && m, N = (0, p.useSelect)((e => e(u.CHECKOUT_STORE_KEY).prefersCollection())), S = E.flatMap((e => e.shipping_rates.filter((e => N && (0, y.J3)(e) && e.selected || !N && e.selected)).flatMap((e => e.name)))), I = (0, R.K5)(h), O = (0, L.iG)(C, N, E);
				return (0, n.createElement)("div", {
			...
			const p = () => {
				...
				u = ({
					...
					const {
						...
						removeCoupon: i,
						isRemovingCoupon: u
					} = (0, l.K)("wc/cart"), m = (0, c.getCurrencyFromPriceResponse)(t);
