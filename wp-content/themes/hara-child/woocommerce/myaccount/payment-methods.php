...
<?php else : ?>
	...
	<?php wc_print_notice( esc_html__( 'لم يتم العثور على طرق محفوظة.', 'woocommerce' ), 'notice' ); ?>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<a class="button" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'إضافة طريقة دفع', 'woocommerce' ); ?></a>
<?php endif; ?>
